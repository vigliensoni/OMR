...
print "OIOI", staves[0][0].average_y
...
#		print "    %d. line at y-position:" % (j+1), line.average_y
		...
		stavelines.append([i+1, (j+1)*2+1, line.average_y])
		stavelines.append([i+1, (j+1)*2+2, line.average_y + st_space/2])
		#stafflines.append(i, j, average_y)
#	for k in range(0,4):
	stavelines.append([i+1, 0, (staves[i][0].average_y)-3*st_space/2]) ### EXTRA LINES AND SPACES
	stavelines.append([i+1, 1, (staves[i][0].average_y)-2*st_space/2])
	stavelines.append([i+1, 2, (staves[i][0].average_y)-1*st_space/2])
	stavelines.append([i+1,11, (staves[i][3].average_y)+2*st_space/2])
	stavelines.append([i+1,12, (staves[i][3].average_y)+3*st_space/2])
